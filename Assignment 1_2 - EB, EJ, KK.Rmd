...
```{r, the sample mean and the 95-percent confidence interval from the population mean by usuing one sample t-test}
...
```{r, displaying results from the cantinous variables, warning=FALSE}
...
grid.arrange(pretty_medinc_hist, pretty_dens_hist, pretty_white_hist, pretty_black_hist,
             ncol = 3)
